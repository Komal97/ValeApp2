...
import com.texi.user.adapter.AllTripAdapter;
...
public class AllBoookingActivity extends AppCompatActivity implements AllTripAdapter.OnAllTripClickListener {
...
//        } catch(IllegalArgumentException e) {e.printStackTrace();}
        ...
        userPref = PreferenceManager.getDefaultSharedPreferences(AllBoookingActivity.this);

        AllTripLayoutManager = new LinearLayoutManager(this);
        recycle_all_trip.setLayoutManager(AllTripLayoutManager);

        ProgressDialog = new Dialog(AllBoookingActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                if (Common.isNetworkAvailable(AllBoookingActivity.this)) {
                    ProgressDialog.show();
                    ...
                    Common.showInternetInfo(AllBoookingActivity.this, "Network is not available");
        ...
        filterDialog = new Dialog(AllBoookingActivity.this,R.style.DialogSlideAnim);
...
//        txt_cancel_popup.setTypeface(Roboto_Bold);
        ...
        common.SlideMenuDesign(slidingMenu, AllBoookingActivity.this,"all trip");
    ...
    public void getAllTrip(final int offset) {
        ...
        Ion.with(AllBoookingActivity.this)
            ...
            .setCallback(new FutureCallback<JsonObject>() {
                ...
                public void onCompleted(Exception error, JsonObject result) {
                    ...
                    if (error == null) {
                            ...
                            if (resObj.getString("status").equals("success")) {
                                ...
                                if (allTripArray != null && allTripArray.size() > 0) {
                                    if (offset == 0) {
                                        ...
                                        allTripAdapter = new AllTripAdapter(AllBoookingActivity.this, allTripArray);
                                        recycle_all_trip.setAdapter(allTripAdapter);
                                        allTripAdapter.setOnAllTripItemClickListener(AllBoookingActivity.this);
                                ...
                                Intent logInt = new Intent(AllBoookingActivity.this, LoginOptionActivity.class);
                                ...
                                if (offset == 0) {
                                    ...
                                    Toast.makeText(AllBoookingActivity.this, resObj.getString("message").toString(), Toast.LENGTH_LONG).show();
                                }
                            }
                       ...
                       Common.ShowHttpErrorMessage(AllBoookingActivity.this, error.getMessage());
                    }
                }
            });
...
public void clickDetailTrip(int position) {
    ...
    if(allTripArray.size() > 0) {
        ...
        Intent di = new Intent(AllBoookingActivity.this, BookingDetailActivity.class);
    ...
    public void tripCancel(final int position) {
        ...
        final Dialog CancelBookingDialog = new Dialog(AllBoookingActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
...
//                        .setMultipartParameter("uid", userPref.getString("id", ""))
                                    ...
                                    try {
                                        ...
                                        if (resObj.getString("status").equals("success")) {
                                            ...
                                            new Handler().postDelayed(new Runnable() {
                                                @Override
                                                public void run() {
                                                    Intent homeInt = new Intent(AllBoookingActivity.this, HomeActivity.class);
    ...
    public void onResume() {
        ...
        IntentFilter filter = new IntentFilter("AllBoookingActivity");
        ...
        common.SlideMenuDesign(slidingMenu, AllBoookingActivity.this, "my trips");
    }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            AllBoookingActivity.super.onBackPressed();
                        }
                    }).create().show();
        }
    }

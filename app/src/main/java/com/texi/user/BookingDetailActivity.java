...
public class BookingDetailActivity extends AppCompatActivity implements FB_Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("Payment ","status : "+allTripFeed.getPaymentStatus());
//        if(!allTripFeed.getPaymentStatus().trim().toString().equals("") && !allTripFeed.getPaymentStatus().equals("0")){
...
//        }else {
            ...
            if(!allTripFeed.getPaymentType().toLowerCase().equals("") && allTripFeed.getPaymentType().toLowerCase().equals("cash")){
                layout_payment_status.setVisibility(View.VISIBLE);
                v_payment_type.setVisibility(View.VISIBLE);
                tv_payment_status.setVisibility(View.VISIBLE);
                tv_payment_status.setText(allTripFeed.getPaymentType().toLowerCase());
                tv_payment_status.setTextColor(ContextCompat.getColor(this,R.color.detail_color));
            }else{
...
//        }
        ...
        if(allTripFeed.getPaymentType().equals("card") && allTripFeed.getStatus().equals("9")){
    ...
    public void onResume() {
        ...
        IntentFilter filter = new IntentFilter("BookingDetailActivity");

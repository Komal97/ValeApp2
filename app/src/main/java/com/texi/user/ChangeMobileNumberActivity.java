...
public class ChangeMobileNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Mobile ","Mobile = "+userPref.getString("mobile","")+"=="+MobileNumberString.length);
        ...
        layout_change_password_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String mobileNo=MobileNumberString[1]+"";

                if(edit_mobile_number.getText().toString().trim().length() == 0){
                    Common.showMKPanelError(ChangeMobileNumberActivity.this, getResources().getString(R.string.please_enter_mobile),rlMainView,tvTitle,regularRoboto);
                    edit_mobile_number.requestFocus();
                    return;
                } else if(edit_country_code.getText().toString().trim().length() == 0){
                    Common.showMKPanelError(ChangeMobileNumberActivity.this, getResources().getString(R.string.please_country_code),rlMainView,tvTitle,regularRoboto);
                    edit_country_code.requestFocus();
                    return;
                }else if(mobileNo.equals(edit_mobile_number.getText().toString())){
                    Common.showMKPanelError(ChangeMobileNumberActivity.this, getResources().getString(R.string.mobile_exit),rlMainView,tvTitle,regularRoboto);
                    edit_country_code.requestFocus();
                    return;
                }
                ...
                try {
                    ...
                    if (resObj.getString("status").equals("success")) {
                        ...
                        if(resObj.getString("code").equals("exists")) {
                            ...
                            Common.showMKPanelError(ChangeMobileNumberActivity.this, message,rlMainView,tvTitle,regularRoboto);
                        }
                    }
